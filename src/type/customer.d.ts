...
export const GOODS_REPORT_STATUS_CODES = {
  GOODS_QNA: 'REPORT.BBS_TYPE.GOODS_QNA',
  GOODS_QNA_ANSWER: 'REPORT.BBS_TYPE.GOODS_QNA_ANSWER',
  GOODS_FEEDBACK: 'REPORT.BBS_TYPE.GOODS_FEEDBACK',
} as const;

export type GoodsReportStatusCode = (typeof GOODS_REPORT_STATUS_CODES)[keyof typeof GOODS_REPORT_STATUS_CODES];
